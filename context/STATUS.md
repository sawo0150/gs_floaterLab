...
- **2026-09-17 (exp94 첫 PSNR 패배·13/17):** UTMM `slow-straight-2` normalized **17.223444**, fresh vanilla **17.349673**, Δ **−0.126230dB**. 양 arm render 1,888/1,888, Adam 177/171, GS 24,366/36,708; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 17.247573 대비 **−0.024129dB**로 사전 >0.5dB 급락 중단선은 미발동. 따라서 **R4의 17/17 승리 추가 목표는 실패 확정**이며, 최소 17-scene 평균≥+0.5dB·과반·전체 fairness는 4 scene 남아 미판정이다. 독립 감사 13/13 오류 0. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 12/17 진행):** UTMM `fast-straight` normalized **16.379936**, fresh vanilla **15.948413**, Δ **+0.431523dB**. 양 arm render 1,348/1,348, Adam 172/165, GS 21,611/33,674; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 16.379202 대비 **+0.000733dB**. 완료된 12개 모두 양수·독립 감사 오류 0, 5개 pending이며 전체 17-scene 판정은 **미완료**. `slow-straight-2` 진행 중. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 11/17 진행):** UTMM `ego-drive` normalized **21.264177**, fresh vanilla **20.560581**, Δ **+0.703596dB**. 양 arm render 11,226/11,226, Adam 898/900, GS 112,222/124,234; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 21.248894 대비 **+0.015283dB**로 급락 없음. 현재 11/17 모두 양수·독립 감사 오류 0, 6개 pending이며 전체 평균/전체 fairness는 **미판정**. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 10/17 진행):** UTMM `ego-centric-2` normalized **19.492180**, fresh vanilla **19.255612**, Δ **+0.236568dB**. 양 arm render 6,655/6,655, Adam 559/556, GS 84,368/108,200; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 대비 **−0.002240dB**로 급락 없음. 완료된 10개는 전부 양수이고 독립 감사 오류 0이지만 17개 전체 평균·fairness는 **미판정**. 다음 UTMM scene 진행 중. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 UTMM 첫 pair PASS·전체 9/17):** `ego-centric-1` normalized **17.758819**, fresh vanilla **17.212576**, Δ **+0.546243dB**. 양 arm render 5,676/5,676, Adam 466/465, GS 78,512/81,552; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 17.755807 대비 **+0.003012dB**, 급락 없음. 완료된 9개 모두 양수·독립 감사 오류 0이나 전체 17개 평균·fairness는 **미판정**. `ego-centric-2` 진행 중. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 RPNG 8/8 완료·UTMM 진행):** `table_08` normalized **23.793198**, fresh vanilla **22.100431**, Δ **+1.692767dB**. 양 arm render 94,283/94,283, Adam 7,465/7,436, GS 923,389/388,806; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 23.860418 대비 **−0.067220dB**로 급락 중단선 이내. RPNG는 **8/8 승리·평균 +1.598585dB**, 독립 감사 완료 8 pair 오류 0. UTMM `ego-centric-1` normalized 17.7588 vs R4 17.7558 gate PASS 후 fresh vanilla 진행 중; 17-scene 전체 판정은 **미완료**. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 7/17 진행):** RPNG `table_07` normalized **26.759564**, fresh vanilla **25.270524**, Δ **+1.489040dB**. 양 arm render 33,422/33,422, Adam 2,691/2,680, GS 344,214/173,121; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 26.840032 대비 **−0.080468dB**이나 0.5dB 급락 중단선 이내. 독립 감사에서 완료 7 pair 모두 오류 0, 나머지 10 pending. `table_08` 진행 중이고 17-scene 전체 판정은 **미완료**. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 6/17 진행):** RPNG `table_06` normalized **24.473087**, fresh vanilla **22.682196**, Δ **+1.790892dB**. 양 arm render 34,437/34,437, Adam 2,714/2,719, GS 329,301/147,478; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 24.487588 대비 **−0.014501dB**이나 >0.5dB 급락은 아니다. 독립 감사에서 완료 6 pair 모두 오류 0, 나머지 11 pending. `table_07` 진행 중이며 전체 17-scene 판정은 **미완료**. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 5/17 진행):** RPNG `table_05` normalized **22.789282**, fresh vanilla **21.700924**, Δ **+1.088358dB**. 양 arm render 52,480/52,480, Adam 4,135/4,138, GS 463,613/212,284; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 22.778009 대비 **+0.011273dB**로 급락 없음. 독립 감사에서 완료 5 pair 모두 오류 0, 나머지 12 pending. `table_06` 진행 중이며 17-scene 전체 기준은 **미판정**. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 4/17 진행):** RPNG `table_04` normalized **22.401817**, fresh vanilla **21.276622**, Δ **+1.125194dB**. 양 arm render 67,793/67,793, Adam 5,359/5,343, GS 752,043/300,165; 구조 12/12·이중 평가·fairness 10/10 PASS. 기존 R4 22.365113 대비 **+0.036704dB**로 급락 없음. 독립 read-only 감사에서 완료된 4 pair 모두 오류 0, 나머지 13 pending. `table_05` 진행 중이며 17-scene 최소 기준은 **미판정**. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 3/17 진행):** RPNG `table_03` normalized **23.555496**, fresh vanilla **21.804534**, Δ **+1.750962dB**. 양 arm render 85,029/85,029, Adam 6,724/6,706, GS 882,185/347,314; 구조 12/12·저장-map 이중 평가·pair fairness 10/10 PASS. 기존 R4 23.504535 대비 **+0.050961dB**로 급락 없음. RPNG `table_01/02/03` 세 pair 모두 양수지만 17개 전체 최소 기준은 **미판정**. 다음 `table_04` 실행 중. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 normalized-vs-vanilla 2/17 진행):** RPNG `table_02` normalized **23.387709**, fresh official vanilla **21.188828**, Δ **+2.198881dB**. 양 arm render 53,669/53,669, Adam 4,229/4,231, GS 592,567/257,882; 구조 12/12·저장-map 이중 평가·pair fairness 10/10 PASS. 기존 R4 23.295651 대비 **+0.092057dB**로 급락 없음. `table_01`도 +1.652589dB로 현재 2/17, 다음 `table_03` 실행 중. 전체 평균·과반·17/17 판정은 **아직 하지 않는다**. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp94 evaluator 수정 후 normalized-vs-vanilla 공식 첫 pair PASS, 1/17):** RPNG `table_01`에서 normalized **25.581416**, fresh official vanilla **23.928826**, Δ **+1.652589dB**. 양 arm physical render 38,302/38,302, Adam 3,030/3,027, Gaussian 417,561/181,900; 구조 12/12·저장-map 이중 평가·pair fairness PASS. 기존 R4 25.624315 대비 **−0.042900dB**로 >0.5dB 급락 중단선 미발동. 이 결과는 exp93에서 수정한 RPNG `--undistort` 명령과 새 source lock/새 output만 사용했다. 전체 17-scene 최소 기준과 R4 추가 목표는 **미판정(1/17)**이며 나머지 scene을 사전 규칙대로 진행한다. → [exp94](experiments/exp94_fixed_evaluator_normalized_panel.md)
- **2026-09-17 (exp92/93 RPNG PSNR 급락 원인 확정·평가 어댑터 수정):** exp92의 동일 PLY 저/고 평가 **20.785455/25.574595dB**에서 rendered prediction·pose·projection·background는 SHA가 같고 GT tensor만 달랐다. exp93의 혼합-inventory 평가 세 번은 모두 **20.789347dB**, 실제 argv에 `--undistort`가 없고 전처리 flag=false였다. 원인은 `run_exp78b_r4_aria.install_extension()`이 RPNG/UTMM의 distortion-aware `evaluation_command`까지 Aria 명령으로 덮어쓴 것. exp87/88/91의 낮은 수치는 mapper 붕괴나 시간에 따른 stochastic evaluator가 아니라 **잘못된 GT 전처리 계약**이므로 해당 해석을 철회한다. Aria 전용 위임 범위를 수정했고 RPNG/UTMM/Aria 회귀 테스트 2개 PASS. 새 source lock의 exp94 첫 공식 pair 재실행 전까지 normalized-vs-vanilla **0/17**, 전체 loop STOP. → [exp92](experiments/exp92_evaluator_tensor_branch.md), [exp93](experiments/exp93_evaluator_preprocess_root_cause.md)
- **2026-09-17 (exp91 v2.1 double-eval fail-stop — 2회 일치로는 해결 안 됨):** RPNG `table_01` normalized 새 PLY에서 구조 gate 12/12 PASS였지만 15초 cooldown 뒤 **20.783158/20.783158dB**의 두 독립 평가가 bitwise 동일한 낮은 군집에 머물렀다. 기존 R4 대비 −4.841157dB의 사전 중단선을 지켜 vanilla·후속 scene은 미실행(정식 0/17). 약 1분 뒤 동일 SHA PLY 세 번째 평가는 **25.574971dB**로 높았다. 따라서 exp90의 `15초 cooldown+2회 일치`는 근본 수정/충분한 gate가 아니며, 이를 공식 PSNR로 고르지 않는다. 다음은 GPU pose/render tensor 수준 분기와 독립 reference 검증이다. → [exp91](experiments/exp91_double_eval_guard_failure.md)
- **2026-09-17 (exp90 exp88/exp87 급락 원인 정정 — evaluator first-pass 불일치, 전체 loop STOP):** exp88 normalized의 **같은 PLY**를 재평가하자 fixed held-out **20.787371→25.584315dB**였다. exp87 R4 wrapper repeat2도 **20.810871→25.620909**, 신규 wrapper repeat4도 **20.803644→25.632411**로 동일 오류가 반복됐다. 따라서 normalized selector나 PIPE mapper가 −4.8dB 나쁜 map을 만든다는 이전 해석은 철회한다. 15초 post-map cooldown 1회에서는 같은 PLY SHA를 유지하며 첫/둘째 평가 **25.619360/25.619360** exact였으나 저수준 evaluator 원인은 OPEN. 양 arm cooldown+독립 2회 평가 불일치 fail-stop 계약이 검증되기 전 17-scene loop와 공식 표는 보류한다. → [exp90](experiments/exp90_evaluator_first_pass_reproducibility.md)
- **2026-09-17 (exp89 RPNG selector-family isolation — map 급락 가설 기각):** 새 source/direct-file R4 control **25.626168dB**, normalized dense-only **25.617035**, aux-only **25.619359**, native-only **25.577844**, all **25.582127/25.586699**였다. 동일 frozen tracker·3,030 Adam/38,302 render/zero-tail에서 단독 family의 선택 UID trace는 exp88 low run과 같았다. 첫 선택 차이는 dense event14, aux event118, native audit235이며, 어떤 단독 family도 급락하지 않았다. exp88 20.787은 저장 map 재평가 시 25.584로 복원되어 평가 재현성 문제로 귀결된다. → [exp89](experiments/exp89_normalized_selector_family_isolation.md)
- **2026-09-17 (exp88 normalized-variance metric benchmark v2 — 첫 RPNG gate에서 STOP):** B-track 17개 유효 scene에 대해 normalized ERCB와 official vanilla를 모두 direct-file 런처/동일 frozen tracker/render ledger로 새로 비교하는 v2 계약을 고정했다. 첫 RPNG `table_01`에서 normalized held-out **20.787371dB**, 현재 direct shortfall **25.619726dB(−4.832355)**, 기존 vanilla 참고 **23.929422dB(−3.142051)**였다. Archive/config/event/3,030 Adam/38,302 render/dense admission/opportunity/502 held-out/zero-tail 등 품질 gate 구조 12/12 PASS였지만 사전 `R4보다 >0.5dB 하락` 중단선을 크게 넘었다. **전체 loop와 v2 vanilla는 실행하지 않았다(정식 pair 0/17).** Exp87의 작은 차이는 양 arm이 낮은 실행 군집에 있었기 때문이며 normalized 채택/전 scene 이득 주장은 보류한다. 다음은 direct-file 고정에서 dense·aux-KF·native-KF normalized selector를 한 family씩 분리해 첫 map 분기 원인을 찾는다. → [v2 결과](experiments/benchmark_custom/metric_benchmark_v2_normalized_variance_20260917/README.md)
