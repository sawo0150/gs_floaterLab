...
| **Strict streaming 1.5×** | **exp57 fixed-eval mapping exclusion + freeze1050/append birth/offsets1+4** | **strict-disjoint fixed 252-view 26.069dB** | **SSIM/LPIPS 0.83314/0.33314, 4,715 update, 78,534GS, RGB+IMU only, MPS 없음, tail update 0, 97.238s < 97.65s. 27dB까지 0.931dB. 기존 union 26.396 및 force-final 26.426은 held-out best에서 제외** |
