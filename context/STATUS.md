...
| **Strict streaming 1.5×** | **exp57 Gaussian-full random replay + late map iters2 + PGBA cutoff1120** | **held-out 24.319 / kf 24.385** | **RGB+IMU only, MPS 없음, tail update 0, 97.264s < 97.65s deadline, 5,087 replay step. deadline-valid 신기록** |
