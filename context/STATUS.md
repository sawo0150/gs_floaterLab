...
| **Strict streaming 1.5×** | **exp57 causal trajectory-filler offset4 + PGBA residual 보존** | **held-out 24.538 / kf 24.521** | **RGB+IMU only, MPS 없음, tail update 0, 97.309s < 97.65s deadline, 5,025 replay step. deadline-valid 신기록** |
