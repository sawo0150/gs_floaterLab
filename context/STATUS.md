...
| **Strict streaming 1.5×** | **exp57 causal trajectory-filler dense pose + PGBA residual 보존** | **held-out 24.483 / kf 24.520** | **RGB+IMU only, MPS 없음, tail update 0, 97.287s < 97.65s deadline, 4,581 replay step. deadline-valid 신기록** |
