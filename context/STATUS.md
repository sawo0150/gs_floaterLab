...
| **Strict streaming 1.5×** | **exp57 freeze1050 + offsets1+4 dense-only random start700** | **held-out 26.396 / kf 27.299** | **동일 조건 반복 26.083dB. RGB+IMU only, MPS 없음, eval offset0 제외, tail update 0, 97.290s < 97.65s. 최고값 기준 27dB까지 0.604dB** |
