...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). **새 strict best 24.099/24.202dB, 4,730 Gaussian-full random update, 97.274s로 deadline 0.376초 통과**. late map iters7→2 예산 재배분과 fixed-map 성공 조건(all-Gaussian gradient)의 빠진 조합을 채택; 기존 deadline-valid 23.782 대비 +0.317dB. 다음은 late PGBA 직후 재수렴 예산 집중. 27dB 전 hard carve 보류 | **strict 최고 24.099 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
