...
| exp51 | Incremental mapping 30dB+로: **축A(25.29dB,+2.42)+축B(중복방지,PSNR무변화·N-16%) 완료. 축C(밀도2배, 고정예산) 25.11 — 무효과, 다음 방향 결정 필요**(예산비례 재검증 vs 축D/E 전환) | 진행중 | [exp51](exp51_dense_supervision_plan.md) |
