...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). 완료된 causal interval의 RGB pose를 optical trajectory-filler로 보정하고 PGBA 뒤에도 local SE(3) residual을 보존해 **strict best 24.483/24.520dB, 4,581 update, 97.287s(deadline +0.363s)** 달성. 기존 interpolation best 대비 held-out +0.164dB. freeze1000은 kf 26.015지만 held-out 24.031로 기각; LR·batch·stride 계열도 full 미달. 27dB 전 hard carve 보류 | **strict 최고 24.483 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
