...
| exp57 | causal background + dense RGB. streaming 중 분산 5k는 2×에서도 24.24dB로 무효, online camera-pose refinement도 22.15dB 붕괴로 기각. 원인은 미성숙 map에 너무 일찍 적용한 update 소실. **최종 채택: timestamp-paced 1× frontier 완료(72.49s) 뒤 non-eval dense RGB 230장으로 pose/exposure 고정 Gaussian-only 5k settle(20.47s)** → held-out/keyframe **27.87/27.82dB**, 합계 **92.96s = live의 1.428×**, 1.5× budget 내 27dB 최초 달성. 무한 live 제품화는 완료 chunk rolling double-buffer 필요 | **성공 — 27dB@1.428× live** | [exp57](exp57_causal_background_polishing_plan.md) |
