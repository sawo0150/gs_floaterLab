...
| exp57 | 1차 목표를 **strict held-out 27dB**로 조정(MPS 절대 금지, RGB+IMU only, fixed 1.5×, tail 0). strict 최고 **23.982dB**. Dense endpoint sampler 뒤 Gaussian-frozen photometric pose alignment는 +0.084dB/약 +0.03초로 작게 유효했지만 no-dense control보다 −0.084dB, 3-step도 상한 개선 없어 direct dense foreground family 기각. 다음은 update 소실을 막는 overlap-aware spatial submap. 27dB 전 hard carve/floater 최적화 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
