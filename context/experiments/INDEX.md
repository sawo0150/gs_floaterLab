...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). strict 최고 **23.982dB**. spatial double-buffer full은 23.782. growing-map random은 600-frame에서 +2.315dB였지만 full은 start300 22.404/start899 22.777로 역전. fixed lineage union도 22.044. 최선의 deadline-valid 재배분은 appearance random 2,056회+late iters2의 **23.060/23.345dB, 97.435s**로 품질 미달. same-global-tensor background 축 종료, 다음은 keyframe-local stable submap+late overlay render-time union. 27dB 전 hard carve 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
