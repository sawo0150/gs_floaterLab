...
| exp57 loss-priority50 | causal per-view loss EMA로 background step의 50%를 어려운 dense RGB에 재배분. fixed **26.9249dB**(uniform 2-run 평균 대비 −0.0956), SSIM/LPIPS는 소폭 개선, 4,927 update, 97.2459s/tail0 | **기각 — uniform shuffled 유지** | [exp57](exp57_causal_background_polishing_plan.md) |
