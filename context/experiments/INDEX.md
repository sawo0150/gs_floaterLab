...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). strict 최고 **23.982dB**. growing-map random·fixed lineage·spatial double-buffer에 이어 independent origin-partition dual-map union도 600 prefix 22.665(+0.204)였지만 full은 **22.786/22.714dB, 99.490s**로 품질·deadline 모두 기각. same-tensor와 submap/merge/union 축 종료. 27dB 전 hard carve 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
