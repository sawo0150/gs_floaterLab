...
| exp57 | 1차 목표를 **strict held-out 27dB**로 조정(MPS 절대 금지, RGB+IMU only, fixed 1.5×, tail 0). dense scheduler 누락 수정으로 strict 최고 **23.982dB**. snapshot full/alpha/overlap merge는 control 대비 −0.27~−2.51dB, dense foreground global-slot 주입도 600-frame에서 −0.36~−0.54dB라 기각. 다음은 pose-confidence 기반 causal dense sampler. 27dB 전 hard carve/floater 최적화 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
