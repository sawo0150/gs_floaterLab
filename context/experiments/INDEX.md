...
| exp51 | Incremental mapping 30dB+로: **축A+B+C 종결, 현재 최선 25.29dB(depth+dedup).** 밀도(축C)는 고정·비례 예산 둘 다 무효과(25.11/25.30) 확정 — per-view 진단상 잔여 갭은 아키텍처가 아니라 저텍스처/specular 콘텐츠. 다음 축E(floater) | 진행중 | [exp51](exp51_dense_supervision_plan.md) |
