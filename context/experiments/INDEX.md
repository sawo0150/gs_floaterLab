...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). causal trajectory-filler offset4 replay를 유지하고 regular growing-map만 frame1050에서 고정해 **strict best 25.435/27.548dB** 달성(no-freeze 대비 held-out +0.897dB). 동일 조건 반복도 25.347dB로 재현. freeze1000/1075/1100은 25.050/25.198/24.685dB로 1050 미달. 두 1050 run 모두 deadline/zero-tail 통과. 27dB 전 hard carve 보류 | **strict 최고 25.435(반복 25.347) / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
