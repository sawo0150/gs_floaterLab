...
| exp57 | causal background polishing. 고정 checkpoint full 곡선은 2k/14.2s에 held-out +1.28dB, 5k/36.3s에 +2.15dB; 5k→26k는 +0.07dB뿐이라 후반 과적합 확인. SH-only는 2k/9.3s +0.59dB로 상한이 낮고, paced 1253 scheduler 768-step A/B는 −0.08dB로 기각. **핵심 반전: timestamp-paced control 자체가 74.75s/65.1s=1.15배라 기존 unpaced 0.68배는 true-streaming 보장이 아니었음** — live adapter 전에 paced baseline/deadline budget부터 해결 | **Phase 0 완료·Phase 1 보류** | [exp57](exp57_causal_background_polishing_plan.md) |
