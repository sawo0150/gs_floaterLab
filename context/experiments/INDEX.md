...
| exp57 | causal background + dense RGB. **최종 채택: timestamp-paced 1× frontier 72.49s + non-eval dense RGB Gaussian-only 5k 20.47s** → held-out/keyframe **27.87/27.82dB**, **1.428× live**. 후속 Aria gray geometry-only/RGB appearance+opacity split은 무제한 20.77dB, gray 10%+trust-region도 24.83dB로 실패. opacity-independent carve-score top-5% prune도 24.72→22.30dB, 총 1.552×로 실패. 기존 채택 유지 | **성공 유지 — gray/carve 분기 기각** | [exp57](exp57_causal_background_polishing_plan.md) |
