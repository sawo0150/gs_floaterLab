...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). strict 최고 **23.982dB**. Dense PCGrad는 600 control 22.461 대비 최선 22.405로 미달. frame899 stable-map boundary는 random view settle이 temporal round-robin보다 +4.0dB이고 cutoff 이전을 약 26.57dB까지 높였으나 late coverage가 15~16dB로 붕괴해 전체 **23.080/26.097dB, 3,399 step, 97.289s(deadline 통과)**. full completed snapshot random delta도 appearance-only 22.234로 control 미달. 다음은 stable base+late overlay를 공동 렌더 loss로 reconciliation하는 spatial double-buffer. 27dB 전 hard carve 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
