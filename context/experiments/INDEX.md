...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). 완료된 causal interval의 RGB pose를 optical trajectory-filler로 보정하고 PGBA 뒤 local SE(3) residual을 보존. offset 선별 결과 offset4 단독으로 **strict best 24.538/24.521dB, 5,025 update, 97.309s(deadline +0.341s)** 달성. 여러 optical phase 혼합은 600-frame에서 −1.5dB 이상으로 기각. freeze1000은 kf 26.015지만 held-out 24.031; LR·batch·stride 계열도 full 미달. 27dB 전 hard carve 보류 | **strict 최고 24.538 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
