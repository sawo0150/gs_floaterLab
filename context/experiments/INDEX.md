...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). evaluator union/keyframe 누수를 바로잡아 fixed 252-view를 Gaussian init·birth·map·background supervision에서 제외. 최초 유효 기준선 **26.069dB**, 4,715 update, 78,534GS, 97.238s, tail 0. late 1000–1199/1200–1252가 23.723/20.334dB로 병목. recent50 appearance+opacity는 25.443, topology-only freeze1050도 25.472로 기각해 두 축 종료. 채택 구조는 freeze1050+append-only PPM birth이며 기존 legacy/force-final은 held-out best 제외, 27dB 전 hard carve 보류 | **strict-disjoint 26.069dB / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
