...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). strict 최고 **23.982dB**. independent dual-map union full 22.786/99.490s, mature-row 별도 Adam full 21.983/98.966s 기각. target-row dense PCGrad 20.636, topology-only freeze 17.135, least-used historical balancing **19.859dB**로 600에서 기각. same-tensor background·submap/merge/union·gradient projection·early topology freeze·count-only balancing 종료. 다음 sampler는 current-map residual 기반. 27dB 전 hard carve 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
