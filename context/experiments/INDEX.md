...
| exp57 | causal stable-map polishing + dense RGB. 4-offset 954장 고정-map 15k는 held-out/keyframe **30.389/30.321dB**지만 총 **2.124× live**. Aria **photo+IMU only** strict 1.5×(MPS 거부, tail 0)은 rolling **23.870/24.300dB**. 후속 same-tensor completed-lineage freeze도 **18.004/18.071dB**, 96,757 GS, visible floater **27.840%**, 102.391s=**1.573×**로 더 크게 붕괴해 기각 | **품질 상한 성공 / pure-online rolling·same-tensor freeze 실패** | [exp57](exp57_causal_background_polishing_plan.md) |
