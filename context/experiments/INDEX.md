...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). frame1050에서 map을 고정하되 이후 도착 RGB도 causal replay하도록 opt-in을 추가했다. offset4는 25.616dB, 평가 offset0을 제외한 offsets1+4는 **strict best 26.129/27.152dB**, SSIM 0.82804, 5,576 update, 97.309s 달성. offsets1–4 전체는 CUDA assert로 실패·판정 제외. 27dB까지 0.871dB, 그 전 hard carve 보류 | **strict 최고 26.129 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
