...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). background 전용 RNG로 thread-race를 분리하고 shuffled dense epoch를 3회 검증: **26.402/26.639/26.528dB**, median/mean 26.528/26.523으로 independent 평균 대비 +0.095dB, 채택. newborn RGBD·birth 2×·forced keyframe은 종료. 27dB까지 0.361dB, 그 전 hard carve 보류 | **strict-disjoint 26.639dB 단일 최고 / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
