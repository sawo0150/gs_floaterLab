...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). background 전용 RNG+shuffled dense epoch에서 idle guard 0ms를 2회 검증: **26.882/26.764dB**, 평균 26.823으로 1ms 평균 대비 +0.104dB, 채택. 5,234~5,731 update, 97.233~97.252s, tail 0. newborn RGBD·birth 2×·forced keyframe은 종료. 27dB까지 0.118dB, 그 전 hard carve 보류 | **strict-disjoint 26.882dB 단일 최고 / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
