...
| exp57 | causal stable-map polishing + dense RGB. 4-offset 954장 고정-map 15k는 held-out/keyframe **30.389/30.321dB**지만 총 **2.124× live**. Aria **photo+IMU only** strict 1.5×(MPS 절대 금지, tail 0)은 rolling **23.870/24.300dB**. cutoff 수정 freeze 22.002, prune+online carve 21.868로 기각. optimizer-independent snapshot도 all-param **20.926**, appearance-only **23.551dB / 1.596×**로 rolling보다 낮아 기각. CUDA subset +2.05%, fast loop 5k 19.30s/28.325dB라 30dB pure-online에는 frontier supervision coverage/update 압축이 필요 | **품질 상한 성공 / pure-online freeze·snapshot 실패** | [exp57](exp57_causal_background_polishing_plan.md) |
