...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). strict 최고 **23.982dB**. Dense PCGrad·단일 freeze·snapshot delta는 모두 control 미달. spatial double-buffer는 600-frame에서 +0.542dB였지만 full strict는 **23.782/25.039dB, 1,436 step, 65,996GS, 97.285s(deadline 통과)**로 최고보다 −0.200dB여서 기각. prefix 이득이 late coverage로 일반화되지 않았으며 27dB 전 hard carve 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
