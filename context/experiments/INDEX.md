...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). strict 최고 **23.982dB**. independent dual-map union full 22.786/99.490s, mature-row 별도 Adam full 21.983/98.966s 기각. regular mapper 내부 target-row dense PCGrad도 600에서 **20.636dB(control 대비 −1.825)**로 즉시 기각. same-tensor background·submap/merge/union·gradient projection 대상 변형 종료, 다음은 projection 없는 per-arrival supervision 개선. 27dB 전 hard carve 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
