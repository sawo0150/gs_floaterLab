...
| exp57 | causal stable-map polishing + dense RGB. non-evaluator supervision을 1 offset 239장→4 offsets 954장으로 확대하고 source별 loss gradient 분리(keyframe=RGB+BA depth+normal, dense=RGB-only), parameter hard split 없이 둘 다 all Gaussian update. **15k/62.83s에 held-out/keyframe 30.389/30.321dB**, 20k 30.505/30.428. online 포함 **2.124× live**라 품질 30dB는 달성, 실시간 압축은 후속. hard split 25.04, soft 28.83, exposure 28.23, Aria gray 20.77~24.83, carve-prune 22.30은 기각 | **성공 — held-out 30dB 최초 달성** | [exp57](exp57_causal_background_polishing_plan.md) |
