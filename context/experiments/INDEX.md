...
| exp57 | 1차 목표를 **strict held-out 27dB**로 조정(MPS 절대 금지, RGB+IMU only, fixed 1.5×, tail 0). dense scheduler의 unseen keyframe 구간 누락을 수정해 등록 450→**931장**, held-out **23.870→23.982dB(+0.112)**로 현재 strict 최고. late map 반복 재배분은 4,215 update에도 24.113, tracking 10fps는 23.417, fixed-horizon temporal chunk는 18.860으로 기각. 27dB 전 hard carve/floater 최적화 보류. 고정-map 상한은 15k 30.389dB | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
