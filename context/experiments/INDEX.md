...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). background/frontier 전역 RNG thread-race를 분리해 fixed 26.414/26.441dB(반복차 0.028dB)로 안정화 채택. newborn RGBD·birth 2×·forced keyframe은 paired late-bin 기준 종료. 숫자상 best 26.535는 비채택 2× run, 안정화 recipe 중심 26.428dB. 다음은 shuffled-uniform dense sampling 효율 검증. 27dB 전 hard carve 보류 | **strict-disjoint 26.535dB 단일 최고 / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
