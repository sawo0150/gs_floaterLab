...
| exp57 | causal stable-map polishing + dense RGB. 4-offset 954장 고정-map 15k는 held-out/keyframe **30.389/30.321dB**지만 총 **2.124× live**. Aria **photo+IMU only** strict 1.5×(MPS 거부, tail 0)은 mature-start+lagged rolling 1,441 step에도 **23.870/24.300dB**, 66,214 GS, 102.129s=**1.569×**, visible-floater 13,611/62,918(21.633%)로 실패. batch4/LR×2/coarse-to-fine도 기각 | **품질 상한 성공 / pure-online 1.5× 30dB 실패** | [exp57](exp57_causal_background_polishing_plan.md) |
