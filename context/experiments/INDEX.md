...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). fixed evaluator 252장을 모든 mapping supervision에서 제외한 최초 유효 기준선 **26.069dB**, 4,715 update, 78,534GS, 97.238s. late 1000–1199/1200–1252가 23.723/20.334dB로 병목. recent50 appearance+opacity 25.443, topology-only freeze1050 25.472로 두 축 종료. non-eval final endpoint frame1249는 마지막 bin +1.078dB지만 전체 영향 상한이 약 +0.05dB이고 실제 25.144라 기각. 채택 구조는 freeze1050+append-only PPM birth, 27dB 전 hard carve 보류 | **strict-disjoint 26.069dB / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
