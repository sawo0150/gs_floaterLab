...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). per-view 진단으로 frame1000–1199=22.78, 1200–1252=18.88dB의 late coverage 붕괴 확정. post-freeze append-only PPM birth는 paired +0.190dB(26.312), final RGB 강제 keyframe 결합은 **단일 26.426dB 신기록**이나 반복 26.321로 미재현. 기존 안정 recipe 최고/반복은 26.396/26.083. late 강제 표집과 grayscale gradient 분리는 기각. 27dB 전 hard carve 보류 | **strict 단일 최고 26.426(반복 26.321) / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
