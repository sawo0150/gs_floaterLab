...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). strict 최고 **23.982dB**. independent dual-map union full 22.786/99.490s 기각. regular mapping은 보존하고 추가 dense gradient만 mature-origin 행에 제한한 새 대조군도 600은 23.444(+0.983)였지만 full은 **21.983/22.144dB, 98.966s**로 역전. same-tensor background와 submap/merge/union 축 종료, 다음은 regular mapper per-arrival supervision 개선. 27dB 전 hard carve 보류 | **strict 최고 23.982 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
