...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). background 전용 RNG+shuffled dense epoch 위에서 idle guard 5→1ms를 2회 검증: **26.687/26.752dB**, 평균 26.719로 직전 shuffled 평균 대비 +0.196dB, 채택. 5,166~5,335 update, 97.229~97.242s, tail 0. newborn RGBD·birth 2×·forced keyframe은 종료. 27dB까지 0.248dB, 그 전 hard carve 보류 | **strict-disjoint 26.752dB 단일 최고 / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
