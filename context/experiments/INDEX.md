...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). newborn RGBD 보정과 birth 2×는 paired late-bin 기준 기각. forced late keyframe 4장 보존은 late bins를 +0.32/+1.34dB 회복했지만 전체 25.720dB로 −0.73dB라 기각하고 PGBA cutoff 이후 frame만 쓰는 교란 분리 중. 기존 recipe 분산 26.069~26.535, 27dB는 반복 재현 필수. recent sampling/topology/final endpoint 종료, 27dB 전 hard carve 보류 | **strict-disjoint 26.535dB 단일 최고 / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
