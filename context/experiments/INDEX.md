...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). freeze1050+optical offsets1+4 dense-only random에서 **strict 최고 26.396/27.299dB**, 반복 26.083dB. per-view 진단으로 frame1000–1199=22.78, 1200–1252=18.88dB의 late coverage 붕괴 확정. post-freeze append-only PPM birth는 paired +0.190dB(26.312)였지만 최고 미달, late 강제 표집은 마지막 구간만 회복하고 전역 품질 훼손. grayscale geometry/RGB appearance 분리도 25.439dB로 기각. 27dB 전 hard carve 보류 | **strict 최고 26.396(반복 26.083) / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
