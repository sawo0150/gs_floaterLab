...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). background RNG+shuffled epoch+idle guard 0ms 3회는 **26.882/26.764/26.628dB**(평균 26.758), 모두 deadline/tail0. recent5%=26.472, freeze1040=26.489, SSIM interval2=26.703(처리량 증가 0·LPIPS 악화)로 모두 기각. 27dB까지 단일 최고 기준 0.118dB, 그 전 hard carve 보류 | **strict-disjoint 26.882dB 단일 최고 / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
