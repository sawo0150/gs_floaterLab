...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). **새 strict best 24.099/24.202dB, 4,730 Gaussian-full random update, 97.274s로 deadline 0.376초 통과**. late map iters7→2 + all-Gaussian gradient 채택. PGBA moment 변환·late-iters1 기각. post-PGBA1188 burst는 idle 기회 0회, 22.997dB/97.867s로 기각; 다음은 final PGBA 조기 종료. 27dB 전 hard carve 보류 | **strict 최고 24.099 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
