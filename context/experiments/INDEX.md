...
| exp51 | Incremental mapping 30dB+로: **축A 완료(D1-b 23.11→25.29dB, λ=0.5, +2.42)**, **축B 완료(중복방지 init, PSNR 무변화·N -16%, C의 인에이블러)**, 다음 축C(keyframe 밀도 57→2/3/4배) | 진행중 | [exp51](exp51_dense_supervision_plan.md) |
