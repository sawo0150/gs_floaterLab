...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). exact-newborn RGBD full 1-step(−0.09~−0.12dB)과 geometry 고정 appearance+opacity 1-step(전체 −0.029dB, 직접 영향 52-view −0.132dB)은 모두 paired control보다 낮아 기각. post-freeze PPM birth 2×도 숫자상 **26.535dB**이나 직접 영향 late bins가 악화해 1×/refine=0 유지. 기존 recipe 분산 26.069~26.535, 27dB는 반복 재현 필수. newborn 보정·birth 밀도·recent sampling·topology·final endpoint 종료, 27dB 전 hard carve 보류 | **strict-disjoint 26.535dB 단일 최고 / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
