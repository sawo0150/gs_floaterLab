...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). **strict best 24.319/24.385dB, 5,087 Gaussian-full random update, 97.264s로 deadline 0.386초 통과**. late map iters7→2 + all-Gaussian gradient + late global PGBA cutoff1120 채택. cutoff1070·tracking stride2·replay start400·CUDA batch2 기각. background LR×1.5는 무제한·초기 2,500/1,000-step 제한·parameter-group 분리까지 600 prefix 일부는 양성이었지만 full 23.749~24.217dB로 모두 strict best 미달하여 계열 종료. PGBA moment 변환·late-iters1·post-PGBA burst도 기각. 27dB 전 hard carve 보류 | **strict 최고 24.319 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
