...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). **새 strict best 24.099/24.202dB, 4,730 Gaussian-full random update, 97.274s로 deadline 0.376초 통과**. late map iters7→2 + all-Gaussian gradient 채택, 기존 deadline-valid 23.782 대비 +0.317dB. PGBA xyz Adam moment 공변 변환은 600에서 24.677(변환 없음 24.859)로 기각. 27dB 전 hard carve 보류 | **strict 최고 24.099 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
