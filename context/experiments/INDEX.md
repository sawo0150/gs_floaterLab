...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). freeze1050 뒤 도착 RGB도 causal replay하고 optical offsets1+4만 dense-only random sample. maturity start700에서 **strict 최고 26.396/27.299dB**, SSIM 0.83888, LPIPS 0.31609, 5,112 update, 97.290s. 동일 조건 반복은 26.083dB로 scheduler 변동 기록. start500/650/750, round-robin, late-iters1, full pose, post-freeze LR, 추가 interpolation/gradient split은 모두 미달. 27dB까지 최고값 기준 0.604dB, 그 전 hard carve 보류 | **strict 최고 26.396(반복 26.083) / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
