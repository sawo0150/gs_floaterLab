...
| exp57 | 1차 목표 **strict held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). **새 strict best 24.319/24.385dB, 5,087 Gaussian-full random update, 97.264s로 deadline 0.386초 통과**. late map iters7→2 + all-Gaussian gradient + late global PGBA cutoff1120 채택. PGBA moment 변환·late-iters1·post-PGBA burst 기각. 27dB 전 hard carve 보류 | **strict 최고 24.319 / 27dB 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
