...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). exact-newborn RGBD full 1-step은 paired control보다 −0.09~−0.12dB라 기각. post-freeze PPM birth 2×는 숫자상 **26.535dB**, LPIPS 0.28891 신기록이지만 직접 영향 late bins가 −0.53/−0.37dB라 pre-freeze scheduler 효과로 판정하고 1× 유지. 기존 recipe 분산 26.069~26.535, 27dB는 반복 재현 필수. recent sampling/topology/final endpoint 종료, 27dB 전 hard carve 보류 | **strict-disjoint 26.535dB 단일 최고 / 진행중** | [exp57](exp57_causal_background_polishing_plan.md) |
