...
| exp57 | 1차 목표 **strict-disjoint held-out 27dB**(MPS 금지, RGB+IMU only, fixed 1.5×, tail 0). late-iters3 3회는 **27.004/26.949/26.572dB**(평균 26.842), 최초 27은 1/3회. iters4=26.658, 고정 2단계 second850=26.693/second700=26.792로 모두 기각. wall scheduler 변동을 직접 제어하는 causal replay-step feedback이 다음 | **strict-disjoint 27.004dB 단일 최고 / 반복 27 미달** | [exp57](exp57_causal_background_polishing_plan.md) |
