...
### 지각 지표 (07-12 아침, segment hold-out 163뷰)

| | SSIM | LPIPS(vgg) |
|---|---:|---:|
| baseline (41c) | 0.9167 | 0.3633 |
| 챔피언 (41d) | 0.9152 | 0.3668 |

**사실상 동률** (Δ 0.2~1%) → PSNR -0.44dB는 지각 품질 손실이 아니라 픽셀 수준 잔차(글레어·노출) 맞춤의 상실. **최종 그림: 챔피언 = 지각 동등 + 가시 먼지 -90%+ + PSNR -0.44dB(비지각적).**
