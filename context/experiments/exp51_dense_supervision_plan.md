...
- 상태: **축 A+B+C(D=2) 완료 (2026-07-17) — 현재 최선 25.29dB(A+B). C(고정예산 밀도 2배)는 무효과, 다음 방향 결정 필요.**
...
| 51-C (D=2, 고정 예산) | + keyframe 밀도 2배(113청크) | **25.11 (A+B와 동급, ±0.16)** | iters_per_kf 150→75(총 예산 고정) — 밀도↑ 무효과. 뷰당 학습량 희석 가능성 |
| 51-C (D=3/4) | 보류 | (D=2 결과로 재검토 필요) | 아래 "축 C 소견" 참조 |
