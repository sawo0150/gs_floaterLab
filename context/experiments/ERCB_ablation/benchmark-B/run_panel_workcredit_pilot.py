#!/usr/bin/env python3
"""Run/resume the isolated benchmark-B work-credit pilot manifest.

Identical mechanics to run_panel.py (sequential, resumable, GPU-busy guard),
pointed at evidence/manifest_workcredit_pilot.json instead of evidence/manifest.json so it
...
MANIFEST = HERE / "evidence/manifest_workcredit_pilot.json"
