#!/bin/bash
# exp19: MPS init + MPS cameras + DepthPro ellipsoidal plateau (v4 anchors)
# Same hyperparams as exp08 (best MPS baseline) + plateau loss
...
PLATEAU_CFG=$REPO/configs/plateau_loss/mps_depthpro_v4.yaml

name="exp19_mps_depthpro"
