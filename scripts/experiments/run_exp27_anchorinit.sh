#!/bin/bash
# exp27: plateau anchor를 init point cloud로 직접 사용 — anchor 품질 검증
...
SOURCE=/home/wosas/Desktop/Incremental_mapping_test/gs_floaterLab/results/datasets/mps_anchorinit_v4_depthpro_scene
RESULTS=/home/wosas/Desktop/Incremental_mapping_test/gs_floaterLab/results/experiments

name="exp27_mps_anchorinit"
