...
EXP_ID="exp11"
RUN_NAME="openmavis_full_dens_until7000_prune001_beta1_low_poslr0875"
...
"${PYTHON}" app/train_hydra.py \
  ...
  logging.tags="[openmavis,full,${EXP_ID},dens_until7000,prune001,beta1_low,poslr0875]" \
  ...
  train.position_lr_init=0.00014 \
  train.position_lr_final=0.0000014 \
