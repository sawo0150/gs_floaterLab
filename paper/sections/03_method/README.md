...
| [3.1 Compute-Paced View Growth (★C1)](3-1_compute_paced_view_growth/) | 0.69 p | 4 + `Slot placement.` run-in (12/16/10/12/6줄) | `3-1_compute_paced_view_growth/plan/CURRENT.md` |
...
§3 현재 1.9 p, 팀원 §3.3 이 채워지면 **≈ 2.3 p**. 옛 계획은 3.25 p 였다.
