# 2.2 View Selection / Active Vision

| 항목 | 값 |
|---|---|
| 한 줄 claim | FisherRF류는 active capture 가정, 우리는 arrived-only streaming |
| latex 대상 | `latex/sec/2_related.tex` |
| 담당 | 나 |
| 상태 | plan v01 / draft 없음 |
| 근거 실험 | — |
| 그림·표 | — |
| 목표 분량 | 0.3 p |
| ⚠ claim boundary | EIG의 정확한 계산이 아님을 명시 |
