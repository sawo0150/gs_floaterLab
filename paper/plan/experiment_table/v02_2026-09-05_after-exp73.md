# 실험 테이블 v02 (2026-09-05, exp73 반영)
...
|---|---|---|---|---|---|---|---|
| **P01** | C1 구현 + 이론식 대조 → **B1, B4, B5** | 완료: baseline vs token/no-prepurchase; 남음: token/carry와 순수 gate-removal | `A_paid(u)` vs `⌊u/κ⌋`, admission poll 오차, 최종 pool 크기 | aria1253, 301_305 | 5090 (exp73); 5070Ti 남음 | **Fig.3** admission trace | **부분 완료** — 7 run·526 poll |
