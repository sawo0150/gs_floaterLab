...
| | 쪽 | 문단 |
|---|---:|---|
| 3.0 Problem Formulation | 0.5 | 5 (`Preliminaries.` run-in 포함) |
| 3.1 **Compute-Paced View Growth** (C1) | 0.8 | 5 (`Slot placement.` run-in 포함) + 식3 + **Fig.3** |
| 3.2 **Entropy-Regularized Count Balancing** (C2) | 0.8 | 5 + 식4 |
| 3.3 **Causal Free-Space Carving** (C3) | 0.7 | 팀원 |
| Fig.2 system diagram | 0.45 | |
