...
case "${EXP78_RESERVE_MS:?missing EXP78_RESERVE_MS}" in
    40|20) ;;
    *) echo "reserve must be 40 or 20" >&2; exit 2 ;;
esac
export EXP69_REPLAY_TRACKING_RESERVE_MS=$EXP78_RESERVE_MS
...
echo "EXP78_RESERVE effective_ms=$EXP69_REPLAY_TRACKING_RESERVE_MS"
